...
Нужны Node 24 (версия в `.nvmrc`), Yarn 4 и инстанс Twenty **2.21.0 или новее** — эта планка объявлена в `engines.twenty`, и CI на каждый пуш ставит приложение и гоняет интеграционные тесты на обоих её концах, так что это проверенное обещание, а не догадка.
